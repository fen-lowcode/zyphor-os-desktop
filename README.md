...
👉 **[Click Here To Download Zyphor OS 3 "Bethany" LTS (v3.0.0-alpha)](https://drive.usercontent.google.com/download?id=1GX5M0Htp_jiMmy_Luu9Ztv8ZHSCzSHTt&export=download&authuser=0)** - Future LTS version with Live Mode. Alpha release for testing.  
